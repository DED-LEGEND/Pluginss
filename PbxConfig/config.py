...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "DX_INFO")
    MY_GROUP = os.environ.get("YOUR_GROUP", "DED_LEGEND_TG")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/DED-LEGEND/DX-PBX_2.0")
